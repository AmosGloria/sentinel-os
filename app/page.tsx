        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              ...
              <h1 className="text-7xl lg:text-8xl font-black tracking-tight leading-[0.9] flex flex-col">
                <span>
                  Financial
                </span>
                <span className="italic text-[#155DFC]">
                  Integrity
                  <span />
                </span>
                <span>
...
function ServiceItem({ title, num, desc }: { title: string; num: string; desc: string }) {
  return (
